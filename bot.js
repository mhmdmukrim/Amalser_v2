...
const {Message, StringSession, Image, Video} = require('./amalser/');
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
         ...
         else if (config.AFPLK !== 'MUKRIM' || config.AFPLK !== 'mukrim' || config.AFPLK !== 'Mukrim' || config.AFPLK !== 'pinky') {
         console.log(
            chalk.red.bold('make sure you have typed the correct password'));
         throw new Error("Password Error ⚠⚠ ");         
         return; //created by MUKRIM
         }
        ...
        console.log(
            chalk.green.bold('DEVIL 𝚠𝚘𝚛𝚔𝚒𝚗𝚐 ' + config.WORKTYPE + ' 𝚗𝚘𝚠 🍃'));
    ...
    setInterval(async () => { 
        ...
        var ansk = 'https://gist.github.com/mhmdmukrim/22bfa918e599dc5c07116a91c26b5aca/raw/db7e4ce6db03bdef0f7784fc5aeb563152c101ea/error'
